    ...
    <header id="navbar" role="banner" class="navbar container-fluid navbar-inverse navbar-fixed-top">
      <div class="container-fluid">
        <div class="navbar-header col-lg-2">
          <?php if ($logo): ?>
            <a class="logo navbar-btn pull-left logo-org" href="<?php print $front_page; ?>" title="<?php print t('Home'); ?>">
              <img src="<?php print $logo; ?>" alt="<?php print t('Home'); ?>" />
            </a>
            <a href="<?php print $front_page; ?>" title="<?php print t('prdxn'); ?>" id="logo" class="logo logo-swap">
...
<div class="main-container container">
  ...
  <div class="row">
    ...
    <?php //endif; ?>
      ...
      <div class="customSliders col-lg-12">
        <ul class="slides">
          <li>
            <?php print views_embed_view('page1','page_1'); ?>
          </li>
          <li>
            <?php print views_embed_view('page1','page_2'); ?>
          </li>
        </ul>
      </div>
